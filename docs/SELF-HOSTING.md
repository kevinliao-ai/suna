# AniSora Self-Hosting Guide

This guide provides detailed instructions for setting up and hosting your own instance of AniSora, an open-source generalist AI agent.
...
- Start AniSora using your preferred method
...
AniSora can be started in two ways:
...
For further assistance, join the [AniSora Discord Community](https://discord.gg/Py6pCBUUPw) or check the [GitHub repository](https://github.com/kortix-ai/suna) for updates and issues.
