...
export const useAgents = (
  ...
  return createQueryHook(agentKeys.list(params), () => getAgents(params), {
    staleTime: 5 * 60 * 1000,
    gcTime: 10 * 60 * 1000,
  })(customOptions);
};
...
export const useAgent = (agentId: string) => {
  return createQueryHook(agentKeys.detail(agentId), () => getAgent(agentId), {
    enabled: !!agentId,
    staleTime: 5 * 60 * 1000,
    gcTime: 10 * 60 * 1000,
  })();
...
export const useDeleteAgent = () => {
  ...
  return createMutationHook(deleteAgent, {
