...
import { ArrowRight, ExternalLink, Clock, User, Calendar } from 'lucide-react';
...
const contentSections = [
  {
    ...
    title: 'Introduction',
    description:
      'Learn about Suna AI Worker and how it can transform your automation workflows',
    readTime: '5 min read',
    updated: '2 days ago',
  },
  {
    ...
    title: 'Quick Start',
    description:
      'Get up and running with your first AI agent in under 10 minutes',
    readTime: '8 min read',
    updated: '1 week ago',
  },
  {
    ...
    title: 'Installation',
    description:
      'Step-by-step guide to install and configure Suna in your environment',
          ...
          <div className="max-w-4xl mx-auto px-4 lg:px-8 py-6 lg:py-12">
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-4">
                ...
                <Badge
                  variant="outline"
                  className="bg-muted/60 backdrop-blur-sm border-border/40"
                >
                  Latest
                </Badge>
              </div>
              ...
              <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-3xl">
                ...
                complex workflows. Suna provides everything you need to create
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 mt-6">
                ...
                <Button
                  variant="outline"
                  size="lg"
                  className="w-full sm:w-auto bg-muted/60 backdrop-blur-sm border-border/40"
                >
                  View on GitHub
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {contentSections.map((section) => (
                <Card
                  key={section.id}
                  className="group cursor-pointer transition-all duration-300 hover:scale-105 bg-card/70 backdrop-blur-xl border-border/40 hover:bg-card/80"
                >
