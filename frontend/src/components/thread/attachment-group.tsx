...
export function AttachmentGroup({
  ...
  const renderContent = () => {
    if (layout === 'grid') {
      const shouldLastItemSpanFull =
        sortedFiles.length % 2 === 1 && sortedFiles.length > 1;
        ...
        <div
          className={cn(
            ...
            standalone && !collapsed
              ? 'grid-cols-1 w-full min-w-[300px] sm:min-w-[500px] max-w-[1000px]'
        ...
        <DialogContent className="max-w-3xl max-h-[80vh] overflow-y-auto">
          ...
          <div
            className={cn(
              ...
              standalone && !collapsed
                ? 'grid-cols-1 w-full min-w-[300px] sm:min-w-[600px] max-w-[1200px] mx-auto'
