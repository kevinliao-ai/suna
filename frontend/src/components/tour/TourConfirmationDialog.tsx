...
export const TourConfirmationDialog = React.memo(
  ({ open, onAccept, onDecline }: TourConfirmationDialogProps) => {
          ...
          <div className="relative">
            <AlertDialogHeader className="p-6 pb-4">
              ...
              <AlertDialogDescription>
                ...
                We'll show you the key features and how to make the most of
                Suna.
              </AlertDialogDescription>
            </AlertDialogHeader>
