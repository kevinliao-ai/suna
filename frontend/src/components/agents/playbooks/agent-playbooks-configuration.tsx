...
export function AgentPlaybooksConfiguration({
  agentId,
  agentName,
}: AgentPlaybooksConfigurationProps) {
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 px-6 bg-muted/30 rounded-xl border-2 border-dashed border-border">
          ...
          <p className="text-sm text-muted-foreground mb-6 max-w-sm mx-auto">
            Create your first playbook to automate common workflows with
            variable-driven runs
          </p>
        </div>
      ) : (
