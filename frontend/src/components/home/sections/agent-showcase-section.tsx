...
const CustomAgentCard = () => {
  return (
    <motion.div className="flex flex-col items-start justify-end min-h-[400px] relative group cursor-pointer hover:bg-primary/5 transition-colors duration-300">
      <div className="relative flex size-full items-center justify-center h-full overflow-hidden">
        <div className="pointer-events-none absolute bottom-0 left-0 h-20 w-full bg-gradient-to-t from-background to-transparent z-20"></div>
        ...
        <div className="w-full h-full flex flex-col items-center justify-center gap-6 p-8 text-center">
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed max-w-xs">
              Create a specialized AI Worker tailored to your unique business
              needs and workflow.
            </p>
          </div>
        ...
        <div className="max-w-6xl mx-auto border-l border-r">
          <SectionHeader>
            ...
            <p className="text-muted-foreground text-center text-balance font-medium">
              Specialized AI Workers ready to transform your workflow. Choose
              from our curated team of experts.
            </p>
          </SectionHeader>
