...
export const changeLogData: ChangelogData[] = [
    {
      ...
      description: "Anisora V3 is now available under the permissive Apache 2.0 license, bringing powerful new capabilities to video generation.",
      items: [
    ...
    },
    {
      ...
      description: "We have submitted our work on agent-related research AniMe to arXiv. Stay tuned for further updates!",
      items: [],
      button: {
        url: "https://arxiv.org/",
        text: "View on arXiv"
    ...
    },
    {
      ...
      description: "Anisora V2 weights are now licensed under Apache 2.0 and publicly available for download on ModelScope and Hugging Face.",
      items: [],
      button: {
    ...
    },
    {
      ...
      description: "Fixed Anisora V1 inference bug that was causing video artifacts.",
      items: []
    },
    {
      ...
      description: "Anisora V3 Preview is updated, with new progress to be shared at Siggraph on July 11th.",
      items: []
    },
    {
      version: "Open Source",
    ...
    },
    {
      ...
      description: "Our paper has been accepted by IJCAI25. Camera ready version has been updated.",
      items: []
    },
    {
      ...
      description: "Submitted our paper to arXiv and released the project with evaluation benchmark.",
      items: []
    }
  ];