    ...
    <>
      ...
      <DocsBody className="mb-8">
        ...
        <ul className="list-disc pl-6 mb-6 space-y-2">
          <li>
            <strong>Python 3.11+</strong> - The setup wizard is written in
            Python
          </li>
          <li>
            <strong>Docker</strong> - For running Redis and the full platform
          </li>
          <li>
            <strong>Git</strong> - To clone the repository
          </li>
          <li>
            <strong>Node.js 18+</strong> - Only needed if you choose manual
            setup
          </li>
        </ul>
        ...
        <Alert className="mb-6">
          ...
          <AlertDescription>
            <strong>Recommended:</strong> Use Docker setup for the smoothest
            experience. It handles all dependencies automatically.
          </AlertDescription>
        </Alert>
      </DocsBody>
...
cd suna`,
      ...
      <DocsBody className="mb-8">
        <h2 id="step-3-provide-credentials">
          Step 3: Provide Your Credentials
        </h2>
        <p className="mb-4">
          The wizard will walk you through configuring these services in 17
          steps. Don't worry - it saves your progress!
        </p>

        <h3 id="required-services" className="mb-4">
          Required Services
        </h3>
        <div className="space-y-4 mb-6">
          <div className="border rounded-lg p-4">
            ...
            <p className="text-sm text-muted-foreground mb-2">
              Free tier available. Handles user data, conversations, and agent
              configs.
            </p>
            <p className="text-sm">
              Get it at:{' '}
        ...
        <h3 id="optional-services" className="mb-4">
          Optional Services
        </h3>
        <div className="space-y-4 mb-6">
          <div className="border rounded-lg p-4 opacity-75">
            ...
            <p className="text-sm text-muted-foreground">
              Makes code editing much better. Highly recommended but not
              required.
            </p>
          </div>
          ...
          <div className="border rounded-lg p-4 opacity-75">
            ...
            <p className="text-sm text-muted-foreground">
              Enables extra tools like LinkedIn scraping. Skip for now if you
              want.
            </p>
          </div>
      ...
      <DocsBody className="mb-8">
        ...
        <p className="mb-4">
          The wizard will offer to set up your Supabase database automatically.
        ...
        <Alert className="mb-4">
          <Info className="h-4 w-4" />
          <AlertDescription>
            If you don't have the Supabase CLI, the wizard will let you skip
            this step. You can set up the database manually later using the
            migration files.
          </AlertDescription>
        </Alert>
        ...
        <p className="mb-4">
          <strong>Important:</strong> After the migrations, you'll need to
          manually expose the 'basejump' schema in your Supabase dashboard:
        </p>
      ...
      <DocsBody className="mb-8">
        ...
        <p className="mb-4">
          The wizard automatically starts everything for you! After setup
          completes:
        </p>
        <div className="mb-6">
          <CodeBlock
...
docker compose down`,
      ...
      <DocsBody className="mb-8">
        ...
        <p className="mb-4">
          You should see the Kortix dashboard where you can start chatting with
          Suna or create your own agents.
        </p>

        <Alert className="mb-6">
          <CheckCircle2 className="h-4 w-4" />
          <AlertDescription>
            <strong>Pro tip:</strong> The setup wizard saves your progress. If
            something goes wrong, just run <code>python setup.py</code> again
