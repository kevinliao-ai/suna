...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Kortix AniSora',
    description: 'Replay this Agent conversation on Kortix AniSora',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Kortix AniSora';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Kortix AniSora';
