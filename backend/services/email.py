...
<head>
  ...
  <title>Welcome to AniSora</title>
  <style>
    body {{
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://i.postimg.cc/WdNtRx5Z/kortix-suna-logo.png" alt="Anisora Logo" class="logo">
    </div>
    <h1>Welcome to Anisora!</h1>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to Anisora — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Anisora community <span class="emoji">🌞</span></p>

    <p>— The Anisora Team</p>

    <a href="https://www.anisora.ai/" class="button">Go to the platform</a>
  </div>
</body>
</html>"""
...
Welcome to Anisora — we're excited to have you on board!
...
Thanks again, and welcome to the Anisora community 🌞

— The Anisora Team

Go to the platform: https://www.anisora.ai/

---
© 2024 Anisora. All rights reserved.
You received this email because you signed up for a Anisora account."""
